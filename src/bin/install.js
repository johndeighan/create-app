#!/usr/bin/env node
;
var appName, dir, err, execCmd, gitSetup, git_repo, main, newDirPath, pos;
...
main = async() => {
  ...
  try {
    ...
    await writeFile('./README.md', `${appName} App
===============
...
Describe how to create your app`);
    ...
    jsonTxt = (await readFile(pkgJsonPath, {
      encoding: 'utf8'
    }));
