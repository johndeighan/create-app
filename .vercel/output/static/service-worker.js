const l = /* @__PURE__ */ location.pathname.split("/").slice(0, -1).join("/"), v = [
  l + "/_app/immutable/entry/app.d071b558.js",
  l + "/_app/immutable/chunks/0.f111c15c.js",
  l + "/_app/immutable/chunks/1.c6d1450e.js",
  l + "/_app/immutable/chunks/2.9241411b.js",
  l + "/_app/immutable/chunks/3.dc1d9f57.js",
  l + "/_app/immutable/chunks/4.444ba4ed.js",
  l + "/_app/immutable/chunks/index.dada67a2.js",
  l + "/_app/immutable/chunks/singletons.6a6f7d92.js",
  l + "/_app/immutable/entry/start.7ced4e3d.js",
  l + "/_app/immutable/entry/error.svelte.f462bb43.js",
  l + "/_app/immutable/assets/_layout.0e867e71.css",
  l + "/_app/immutable/entry/_layout.svelte.0e4017cf.js",
  l + "/_app/immutable/assets/_page.78c0e4cb.css",
  l + "/_app/immutable/entry/_page.svelte.1f7e09ff.js",
  l + "/_app/immutable/entry/about-page.md.c9daaa9b.js",
  l + "/_app/immutable/entry/readme-page.md.e0b01582.js"
], j = [
  l + "/favicon.png",
  l + "/favicon.svg",
  l + "/manifest.json",
...
}, C = (a) => [d.prefix, a, d.suffix].filter((e) => e && e.length > 0).join("-"), M = (a) => {
...
async function H(a, e) {
  ...
  }, r = e ? e(n) : n, c = S() ? s.body : await s.blob();
...
class z {
  ...
  async cachePut(e, t) {
    ...
    if (!r)
      return !1;
    const { cacheName: c, matchOptions: i } = this._strategy, o = await self.caches.open(c), u = this.hasCallback("cacheDidUpdate"), g = u ? await B(
    ...
    try {
      await o.put(n, u ? r.clone() : r);
    } catch (f) {
      if (f instanceof Error)
        throw f.name === "QuotaExceededError" && await G(), f;
    }
...
class J {
  ...
  handleAll(e) {
    ...
    const t = e.event, s = typeof e.request == "string" ? new Request(e.request) : e.request, n = "params" in e ? e.params : void 0, r = new z(this, { event: t, request: s, params: n }), c = this._getResponse(r, s, t), i = this._awaitComplete(c, r, s, t);
    return [c, i];
  }
...
p.copyRedirectedCacheableResponsesPlugin = {
  async cacheWillUpdate({ response: a }) {
    return a.redirected ? await H(a) : a;
  }
};
class X {
  /**
  ...
  addToCacheList(e) {
    ...
    for (const s of e) {
      ...
      const { cacheKey: n, url: r } = W(s), c = typeof s != "string" && s.revision ? "reload" : "default";
  ...
  install(e) {
    return P(e, async () => {
      ...
      for (const [r, c] of this._urlsToCacheKeys) {
        const i = this._cacheKeysToIntegrities.get(c), o = this._urlsToCacheModes.get(r), u = new Request(r, {
          integrity: i,
          cache: o,
...
const T = "GET", b = (a) => a && typeof a == "object" ? a : { handle: a };
class w {
  /**
...
class Z {
  ...
  handleRequest({ request: e, event: t }) {
    ...
    let u;
    try {
      u = i.handle({ url: s, request: e, event: t, params: r });
    } catch (f) {
      u = Promise.reject(f);
    }
...
let m;
const ee = () => (m || (m = new Z(), m.addFetchListener(), m.addCacheListener()), m);
function te(a, e, t) {
  let s;
  if (typeof a == "string") {
